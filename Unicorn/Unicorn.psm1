...
$FunctionDefinitions = @(
    ...
    (func unicorn uc_hook_add ($UC_ERR) @([IntPtr], [IntPtr].MakeByRefType(), $UC_HOOK, [MulticastDelegate], [IntPtr], [UInt32], [UInt32]))
)
